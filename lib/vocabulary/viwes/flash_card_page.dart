  ...
  setNewBadge(String category) {
    switch (category) {
      case 'Weather':
        setState(() {
          newBadge = CardBadge(
              kinship: false, dirrection: false, classroom: false, time: true);
        });
        break;
      ...
      case 'Classroom Commands':
        setState(() {
          newBadge = CardBadge(
              kinship: false, dirrection: false, classroom: true, time: false);
        });
        break;
      case 'Days':
        newBadge = CardBadge(
      ...
      case 'Kinship Terms':
        newBadge = CardBadge(
            kinship: true, dirrection: false, classroom: false, time: false);
        break;
      case 'Directions and Time':
        newBadge = CardBadge(
            kinship: false, dirrection: true, classroom: false, time: true);
        break;
      case 'Food':
        newBadge = CardBadge(
            kinship: false, dirrection: false, classroom: false, time: true);
                                ...
                                onFlip: () {
                                  if (index == scoreIndex) {
                                    ...
                                    leaderboardRepo.addToLeaderBoard(
                                        userRepo.user.name, score);
                                    print("score is -------------- $score");
                                    double progress = (scoreIndex /
                                        snapshot.data!
                ...
                Positioned(
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        ...
                        //             seriesName: 'Dvc1tl9L0UYgik1X5zOT')),
                        //   );
                        ...
                        //     MaterialPageRoute(
                        //         builder: (context) => LearningPage(
                        //             seriesName: 'Ge8eXFpeuoMOpt4OJM4l')),
                        //   );
                        ...
                        //     MaterialPageRoute(
                        //         builder: (context) => LearningPage(
                        //             seriesName: 'h3QH0rikK63QTZ7Lr8wP')),
                        //   );
                        ...
                        //     MaterialPageRoute(
                        //         builder: (context) => LearningPage(
                        //             seriesName: 'ueEFv1EI9xm9ciT8u2vt')),
                        //   );
                        ...
                        //     MaterialPageRoute(
                        //         builder: (context) => LearningPage(
                        //             seriesName: 'VJsM4pkVy0h9y74To9PG')),
                        //   );
                        // }
                      },
                      style: ElevatedButton.styleFrom(
                  ...
                  onPressed: () async {
                    ...
                    if (mounted) {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => VocabularyHome()));
                    }
                  },
                ),
                TextButton(
