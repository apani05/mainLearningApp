...
class _UserProfileScreenState extends ConsumerState<UserProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print("UserProvie UID ${UserProvide.uid}");
    return SafeArea(
      child: Scaffold(
        backgroundColor: Colors.grey[400],
        body: FutureBuilder(
            future: UserProvide.getUserProfile(
                          ...
                          Stack(
                            ...
                            children: [
                                          ...
                                          IconButton(
                                            onPressed: () async {
                                              ...
                                              final rank = snapshot.data!.rank
                                                  .toString();
                                              final text =
                                                  'I just scored $score XP and ranked $rank on I\'poyít. Can you beat me?'
                              ...
                              Positioned(
                                ...
                                right: 0,
                                child: Visibility(
                                  visible: widget.uid == UserProvide.uid,
                                  child: Padding(
